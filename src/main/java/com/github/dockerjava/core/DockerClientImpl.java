...
public class DockerClientImpl implements Closeable, DockerClient {
    ...
    @Override
    public InspectTaskCmdImpl inspectTaskCmd(String taskId) {
    ...
    public ListSwarmNodesCmd ListSwarmNodesCmd() {
        return new ListSwarmNodesCmdImpl(getDockerCmdExecFactory().createListSwarmNodeCmdExec());
    }

    @Override
    public InspectSwarmNodeCmd InspectSwarmNodeCmd(String swarmNodeId) {
        return new InspectSwarmNodeCmdImpl(getDockerCmdExecFactory().createInspectSwarmNodeExec(), swarmNodeId);
    }

    @Override
    public RemoveSwarmNodeCmd removeSwarmNodeCmd(String swarmNodeId) {
        return new RemoveSwarmNodeCmdImpl(getDockerCmdExecFactory().createRemoveSwarmNodeCmdExec(), swarmNodeId);
    }

    @Override
    public UpdateSwarmNodeCmd updateSwarmNodeCmd(String swarmNodeId, SwarmNodeSpec swarmNodeSpec) {
        return new UpdateSwarmNodeCmdImpl(getDockerCmdExecFactory().createUpdateSwarmNodeCmdExec(), swarmNodeId ,swarmNodeSpec);
    }
